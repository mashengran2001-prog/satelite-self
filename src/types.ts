...
export type SortMode = "default" | "name" | "latency" | "ippure";
...
export interface IppureResult {
  ...
  city?: string | null;
  error?: string | null;
  /** Stable failure category: abandoned | refused | reset | timeout | dns | tls | auth | blocked | limited | endpoint | response | tunnel | core | status. */
