...
export function SimpleServersPage() {
  ...
  async function onTestAll() {
    ...
    try {
      // Stream each finished probe into the list instead of waiting for the
      // whole batch.
      ...
      <header className="page-header">
        ...
        <div className="header-actions simple-head-actions">
          ...
          <GlassButton
            variant="primary"
            icon="IP"
            disabled={ippureTesting || customRuntime || nodeTotal === 0}
          ...
          >
            {ippureTesting ? t("nodes.ippureTesting") : t("nodes.testIppure")}
          </GlassButton>
        </div>
      </header>
              ...
              return (
                <li key={n.id}>
                  ...
                  >
                    ...
                    />
                    <span className="simple-node-ippure">
                      <IppureDisplay
